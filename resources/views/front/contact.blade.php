...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('{{ asset('front_asset/assets/img/contact-bg.jpg')}}')">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <!-- to get an API token!-->
                            <form id="contactForm" method="post" action="{{url('contact/form_submit')}}">
                                @csrf
                                ...
                                <div class="form-floating">
                                    <input class="form-control" name="mobile" type="tel" placeholder="Enter your mobile number..." data-sb-validations="required" />
